...
class PopulateReleaseWorkspaceContributingWorkspaces(MigratorTestCase):
    """Tests for the populate_contributing_workspaces migration."""

    migrate_from = ("gregor_anvil", "0034_releaseworkspace_contributing_workspaces")
    migrate_to = ("gregor_anvil", "0035_populate_releaseworkspace_contributing_workspaces")
    ...
    def prepare(self):
        ...
        UploadCycle = self.old_state.apps.get_model("gregor_anvil", "UploadCycle")
        UploadWorkspace = self.old_state.apps.get_model("gregor_anvil", "UploadWorkspace")
        DCCProcessedDataWorkspace = self.old_state.apps.get_model("gregor_anvil", "DCCProcessedDataWorkspace")
        ReleaseWorkspace = self.old_state.apps.get_model("gregor_anvil", "ReleaseWorkspace")
        # ConsentGroup FKs.
        consent_group_gru = factory.create(ConsentGroup, code="GRU", FACTORY_CLASS=factories.ConsentGroupFactory)
        consent_group_hmb = factory.create(ConsentGroup, code="HMB", FACTORY_CLASS=factories.ConsentGroupFactory)
        # ResearchCenter FKs.
        research_center_1 = ResearchCenter.objects.create(short_name="rc1", full_name="Research Center 1")
        research_center_2 = ResearchCenter.objects.create(short_name="rc2", full_name="Research Center 2")
        # UploadCycle FKs.
        upload_cycle_1 = factory.create(UploadCycle, FACTORY_CLASS=factories.UploadCycleFactory, cycle=1)
        upload_cycle_2 = factory.create(UploadCycle, FACTORY_CLASS=factories.UploadCycleFactory, cycle=2)
        upload_cycle_3 = factory.create(UploadCycle, FACTORY_CLASS=factories.UploadCycleFactory, cycle=3)
        # Upload workspaces - upload cycle 1.
        workspace = factory.create(
            Workspace,
            workspace_type="upload",
            FACTORY_CLASS=WorkspaceFactory,
        ...
        self.u_uc1_rc1_gru = UploadWorkspace.objects.create(
        ...
        self.u_uc1_rc1_hmb = UploadWorkspace.objects.create(
            upload_cycle=upload_cycle_1,
            research_center=research_center_1,
        ...
        self.upload_uc1_rc2_gru = UploadWorkspace.objects.create(
            upload_cycle=upload_cycle_1,
            research_center=research_center_2,
            consent_group=consent_group_gru,
            workspace=workspace,
        )
        # Upload workspaces - upload cycle 2.
        workspace = factory.create(
            Workspace,
            workspace_type="upload",
            FACTORY_CLASS=WorkspaceFactory,
        ...
        self.upload_uc2_rc1_gru = UploadWorkspace.objects.create(
        ...
        self.upload_uc2_rc1_hmb = UploadWorkspace.objects.create(
            upload_cycle=upload_cycle_2,
            research_center=research_center_1,
            consent_group=consent_group_hmb,
            workspace=workspace,
        ...
        self.upload_uc2_rc2_gru = UploadWorkspace.objects.create(
            upload_cycle=upload_cycle_2,
            research_center=research_center_2,
            consent_group=consent_group_gru,
            workspace=workspace,
        )
        # Upload workspaces - upload cycle 3.
        workspace = factory.create(
            Workspace,
            workspace_type="upload",
            FACTORY_CLASS=WorkspaceFactory,
        ...
        self.upload_uc3_rc1_gru = UploadWorkspace.objects.create(
        ...
        self.upload_uc3_rc1_hmb = UploadWorkspace.objects.create(
            upload_cycle=upload_cycle_3,
            research_center=research_center_1,
            consent_group=consent_group_hmb,
            workspace=workspace,
        ...
        self.upload_uc3_rc2_gru = UploadWorkspace.objects.create(
            upload_cycle=upload_cycle_3,
            research_center=research_center_2,
            consent_group=consent_group_gru,
            workspace=workspace,
        ...
        self.upload_uc3_rc2_hmb = UploadWorkspace.objects.create(
            upload_cycle=upload_cycle_3,
            research_center=research_center_2,
            consent_group=consent_group_hmb,
            workspace=workspace,
        ...
        self.dcc_uc3_gru = DCCProcessedDataWorkspace.objects.create(
            upload_cycle=upload_cycle_3,
            consent_group=consent_group_gru,
            workspace=workspace,
        )
        # First release workspace associated with upload cycle 2.
        workspace = factory.create(
            Workspace,
        ...
        self.release_r1_gru = ReleaseWorkspace.objects.create(
            consent_group=consent_group_gru,
            workspace=workspace,
            full_data_use_limitations="foo",
            dbgap_version=1,
            dbgap_participant_set=1,
            upload_cycle=upload_cycle_2,
            date_released=timezone.localdate() - timedelta(days=10),
        )
        workspace = factory.create(
            Workspace,
            workspace_type="release",
        ...
        self.release_r1_hmb = ReleaseWorkspace.objects.create(
            consent_group=consent_group_hmb,
            workspace=workspace,
            full_data_use_limitations="foo",
            dbgap_version=1,
        ...
        # Second release workspace associated with upload cycle 3.
        workspace = factory.create(
            Workspace,
            workspace_type="release",
            FACTORY_CLASS=WorkspaceFactory,
        ...
        self.release_r2_gru = ReleaseWorkspace.objects.create(
            consent_group=consent_group_gru,
            workspace=workspace,
            full_data_use_limitations="foo",
            dbgap_version=1,
        ...
        self.release_r2_hmb = ReleaseWorkspace.objects.create(
            consent_group=consent_group_hmb,
            workspace=workspace,
            full_data_use_limitations="foo",
            dbgap_version=1,
    ...
    def test_migration(self):
        """Test that all workspaces were correctly added."""
        ReleaseWorkspace = self.new_state.apps.get_model("gregor_anvil", "ReleaseWorkspace")
