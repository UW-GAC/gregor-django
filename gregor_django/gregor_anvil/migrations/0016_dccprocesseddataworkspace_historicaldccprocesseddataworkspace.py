# Generated by Django 3.2.19 on 2023-06-21 00:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('gregor_anvil', '0015_dccprocessingworkspace_historicaldccprocessingworkspace'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dcc_processing_workspace', models.ForeignKey(blank=True, db_constraint=False, help_text='DCC processing workspace where data in this workspace were generated.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='gregor_anvil.dccprocessingworkspace')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dcc_processing_workspace', models.ForeignKey(help_text='DCC processing workspace where data in this workspace were generated.', on_delete=django.db.models.deletion.PROTECT, to='gregor_anvil.dccprocessingworkspace')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('dcc_processing_workspace', 'consent_group'), name='unique_dcc_processed_data_workspace'),
        ),
    ]
